import { ArrowLeft, Mail, Phone, MapPin, Calendar, Edit2, ChevronRight, Check } from 'lucide-react'
    ...
    <div className="flex min-h-full flex-col bg-[#F9F6F2] pb-4">
      <div className="relative">
        <div className="rounded-t-[28px] bg-gradient-to-b from-[#18325b] to-[#1f4b86] px-4 pt-5 pb-8 z-10">
          <Navbar
            ...
            trailing={(
              <button className="inline-flex h-10 w-10 items-center justify-center rounded-full text-white transition hover:bg-white/10">
      ...
      <div className="px-4 -mt-5">
        ...
        <Card className="relative z-20 p-6">
          <div className="flex flex-col items-center">
            <div className="-mt-8 flex h-24 w-24 items-center justify-center rounded-full bg-[#111827] shadow-[0_8px_20px_rgba(27,47,94,0.14)] border-4 border-white">
              <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=200&q=80" alt="avatar" className="h-20 w-20 rounded-full object-cover" />
            </div>

            <h2 className="mt-4 text-[20px] font-semibold text-[#1A2340]">Budi Santoso</h2>
            <p className="mt-1 text-sm text-[#7B8FAB]">Premium Member</p>
            ...
            <div className="w-full space-y-3">
              <InfoRow icon={Mail} title="Email" value="budi.santoso@email.com" />
              <InfoRow icon={Phone} title="Phone" value="+62 812 3456 7890" />
              <InfoRow icon={MapPin} title="Location" value="Jakarta, Indonesia" />
              <InfoRow icon={Calendar} title="Member Since" value="January 2026" />
            </div>
          </div>
        </Card>
        ...
        <div className="space-y-3">
          ...
          <div>
            <button className="w-full rounded-full border border-[#EA556A] bg-white px-4 py-3 text-[15px] font-semibold text-[#D23046]">Logout</button>
          </div>
        </div>
        </div>
      </div>
